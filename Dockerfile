FROM --platform=$BUILDPLATFORM node:22.20.0-bullseye-slim@sha256:81eda6ed8790dcb00e2bafcff9affadee405851f1f5b1dd3004f940982133c76 AS cache-app
WORKDIR /app
...
FROM --platform=$BUILDPLATFORM node:22.20.0-bullseye-slim@sha256:81eda6ed8790dcb00e2bafcff9affadee405851f1f5b1dd3004f940982133c76 AS build-app
...
FROM --platform=$BUILDPLATFORM node:22.20.0-bullseye-slim@sha256:81eda6ed8790dcb00e2bafcff9affadee405851f1f5b1dd3004f940982133c76 AS cache-providers
WORKDIR /providers
...
FROM --platform=$BUILDPLATFORM node:22.20.0-bullseye-slim@sha256:81eda6ed8790dcb00e2bafcff9affadee405851f1f5b1dd3004f940982133c76 AS build-providers
WORKDIR /providers
